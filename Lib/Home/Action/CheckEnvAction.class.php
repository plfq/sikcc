...
class CheckEnvAction extends Action {
...
<style type="text/css">
*{margin:0;padding:0}
    body{font:400 16px/2em '微软雅黑','黑体',Tahoma,sans-serif;text-align:center;background:#fff;}
    table {margin-top:10px;width:700px;margin:0 auto;}
    .red{color:red;font-weight:bold;}
    .blue{color:blue;}
    .toptitle{font-weight:bold;font-size:14px;padding:10px;color:#333;}
	.title{background:#eee;font-weight:bold;font-size:14px;padding:4px;color:#333;text-align:left;}
    .thead{background-color:#eee;color:#333;}
...
<body>
    <div class="toptitle">ThinkPHP环境检测</div>
    <table>
